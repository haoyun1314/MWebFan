...
```
输出结果：
![-w713](media/15859041780635/15862275012980.png)

可以看到：通过线程间的通信，先在其他线程中执行操作，等操作执行完了之后再回到主线程执行主线程的相应操作。


1. NSOperation、NSOperationQueue 线程同步和线程安全
...
![-w699](media/15859041780635/15862277798061.png)
省略一部分结果图。。。

![-w718](media/15859041780635/15862277933119.png)
...
![-w702](media/15859041780635/15862282038637.png)
省略一部分结果图。。。

![-w691](media/15859041780635/15862282161227.png)
